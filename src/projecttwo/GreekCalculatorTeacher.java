...
public class GreekCalculatorTeacher extends Pane {
    ...
    private void formCalculatorTop() {
        ...
        this.calculatorBorderPane.setTop(headerView);
    }
    private void formCalculatorCenter() {
        ...
        calculatorCenterHolder.getChildren().add(formOperationsPanel());
    ...
    private HBox formTextAreasPanel() {
        ...
        while (counter < 2) {
            this.numberTextFields.get(counter).setMaxWidth(100);
            counter++;
        }
    ...
    private HBox formOperationsPanel() {
    ...
    private void processOperationClicked(int finalCounter) {
        this.activeOperationInt = finalCounter;
        this.activeOperationView.setImage(this.operationImageList.get(finalCounter));
    }
    ...
    private ImageView formPeriodButton() {
        ...
        ImageView periodView = new ImageView(new Image("/assets/projecttwo/periodIcon.png"));
    ...
    private ImageView formEqualsButton() {
        ImageView equalView = new ImageView(new Image("/assets/projecttwo/equalsIcon.png"));
        equalView.setFitHeight(125);
        equalView.setPreserveRatio(true);
        equalView.setOnMouseClicked(e -> {
    ...
    private ImageView formClearButton() {
        ImageView clearView = new ImageView(new Image("/assets/projecttwo/clearIcon.png"));
