...
public class Draggable {
    ...
    public interface Interface {
        public abstract Nature getDraggableNature();
    }
    ...
    public static final class Nature implements EventHandler<MouseEvent> {
        ...
        private final List<Node> dragNodes = new ArrayList<Node>();
        private final List<Listener> dragListeners = new ArrayList<Listener>();
        ...
        public final List<Node> getDragNodes() {
            return new ArrayList<Node>(this.dragNodes);
        }
            ...
            if (MouseEvent.MOUSE_PRESSED == event.getEventType()) {
                ...
                if (this.dragging) {
                    ...
                    if (eventNode.getId() != null) {
                       ...
                       // System.out.println("Mouse released at: + X: " + lastMouseX + ", Y" + lastMouseY);
                       // ActionModePanel panel = (ActionModePanel) eventNode;
                        //PanelPosition toBeChanged = panel.getPanelPosition();
                       // toBeChanged.setCurrentPosition(lastMouseX,lastMouseY);
